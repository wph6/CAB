...
class GPT2Attention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if output_QK:
            outputs += (query_states, key_states)
...
class GPT2Block(nn.Module):
    ...
    def forward(
        ...
        if output_QK:
            query_states = attn_outputs[-2]
            key_states = attn_outputs[-1]
            outputs = outputs + ((query_states, key_states),)
...
class GPT2Model(GPT2PreTrainedModel):
    ...
    def forward(
        ...
        all_self_attentions = () if (output_attentions or output_QK) else None
